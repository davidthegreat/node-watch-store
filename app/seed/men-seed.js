...
var mens =  [
  new Men({
    imagePath: 'http://localhost:3000/images/AkribosXXIV.jpg',
    secondimagePath: 'http://localhost:3000/images/AkribosXXIV2.jpg',
    thirdimagePath: 'http://localhost:3000/images/AkribosXXIV3.jpg',
    title: "Akribos XXIV",
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/MovadoCollectionMens.jpg',
    secondimagePath: 'http://localhost:3000/images/MovadoCollectionMens2.jpg',
    thirdimagePath: 'http://localhost:3000/images/MovadoCollectionMens3.jpg',
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/MensBalmerE-Type.jpg',
    secondimagePath: 'http://localhost:3000/images/MensBalmerE-Type2.jpg',
    thirdimagePath: 'http://localhost:3000/images/MensBalmerE-Type3.jpg',
    title: "Balmer E-Type",
  ...
  new Men({
    ...
    secondimagePath: 'http://localhost:3000/images/FossilMensCH25642.png',
    thirdimagePath: 'http://localhost:3000/images/FossilMensCH25643.png',
    title: "Fossil CH2564 Black Leather",
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/AkribosXXIVMensAntiqueMechanical.jpg',
    secondimagePath: 'http://localhost:3000/images/AkribosXXIVMensAntiqueMechanical2.jpg',
    thirdimagePath: 'http://localhost:3000/images/AkribosXXIVMensAntiqueMechanical3.jpg',
    title: "Akribos XXIV  Mechanical",
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/StuhrlingOriginalMensRegattaEspora.jpg',
    secondimagePath: 'http://localhost:3000/images/StuhrlingOriginalMensRegattaEspora2.jpg',
    thirdimagePath: 'http://localhost:3000/images/StuhrlingOriginalMensRegattaEspora3.jpg',
    title: "Stuhrling Original Regatta",
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/StuhrlingOriginalMensAlbionSwiss.jpg',
    secondimagePath: 'http://localhost:3000/images/StuhrlingOriginalMensAlbionSwiss2.jpg',
    thirdimagePath: 'http://localhost:3000/images/StuhrlingOriginalMensAlbionSwiss3.jpg',
    title: "Stuhrling Original Albion",
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/TimexMensT49963Expedition.jpg',
    secondimagePath: 'http://localhost:3000/images/TimexMensT49963Expedition2.jpg',
    thirdimagePath: 'http://localhost:3000/images/TimexMensT49963Expedition3.jpg',
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/JulesBretingAdamaStainlessSteel.jpg',
    secondimagePath: 'http://localhost:3000/images/JulesBretingAdamaStainlessSteel2.jpg',
    thirdimagePath: 'http://localhost:3000/images/JulesBretingAdamaStainlessSteel3.jpg',
  ...
  new Men({
    imagePath: 'http://localhost:3000/images/JoshuaSonsClassicMensJapanese.jpg',
    secondimagePath: 'http://localhost:3000/images/JoshuaSonsClassicMensJapanese2.jpg',
    thirdimagePath: 'http://localhost:3000/images/JoshuaSonsClassicMensJapanese3.jpg',
